...
export default function License() {
  return (
    <div className="bg-[#0B1221] z-10 w-full flex justify-center">
      <div className="container flex flex-col md:flex-row items-center font-medium justify-between py-6 md:py-10 px-4 md:px-10 lg:px-40 text-foreground gap-6 md:gap-0">
        <span className="text-sm md:text-base text-center md:text-left">
          © 2026 Fasonly - All Rights Reserved
        </span>
