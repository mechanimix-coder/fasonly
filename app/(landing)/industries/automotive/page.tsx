...
export default function page() {
  ...
  return (
    <div className="w-full pt-10 pb-20 bg-white">
      <ServicesHero
        title="Otomotiv Ürün Geliştirme için Dijital Üretim"
        desc="Geleneksel, elektrikli ve otonom araçlar için giderek kısalan geliştirme döngülerini hızlı prototipleme ve düşük hacimli üretim ile aşın"
        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
              Otomotiv Şirketleri Fasonly'yi Nasıl Kullanıyor?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Üretim malzemelerinde hızlı iterasyon ve prototipleme yoluyla
                geliştirme hızından ödün vermeden tasarım riskini azaltın.
              </p>
            </div>
      ...
      <div className="w-full bg-gradient-to-r from-[#0B1221] to-[#1a2a3a] py-16">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          ...
          <p className="text-center text-gray-300 text-lg max-w-3xl mx-auto mb-12">
            Dünya çapındaki yenilikçi otomotiv şirketleri için 25 yılı aşkın
      ...
      {/* Manufacturing Services for Automotive Products Section */}
      <div className="w-full bg-white py-20">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          {/* Section Header */}
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
              Otomotiv Ürünleri için Üretim Hizmetleri
            </h2>
            <div className="w-20 h-1 bg-[#96E92A] mx-auto rounded-full"></div>
          </div>
      ...
      <div className="w-full bg-white py-20">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          ...
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
              Otomotiv Endüstrisi için Kalite Önlemleri
            </h2>
            <div className="w-20 h-1 bg-[#96E92A] mx-auto rounded-full mb-6"></div>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 mb-20">
            ...
            <div className="flex-1 relative w-full h-80 md:h-auto min-h-[400px] rounded-xl overflow-hidden shadow-md bg-gray-100">
              <Image
                ...
                alt="Otomotiv Endüstrisi için Kalite Önlemleri"
                fill
                className="object-cover"
              />
            </div>
      ...
      <div className="w-full bg-white py-20">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
              Otomotiv Uygulamaları için Malzemeler
            </h2>
            <div className="w-20 h-1 bg-[#96E92A] mx-auto rounded-full"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  PEEK, asetal dahil yüzlerce termoplastik arasından seçim yapın
                  veya kendi malzemenizi tedarik edin. Uygun projeler için özel
                  renklendirici ile markalaşmayı koruyun.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  Seçici lazer sinterleme ve Multi Jet Füzyon ile mevcut çeşitli
                  naylon malzemelerde fonksiyonel prototipleri 3D baskı ile
                  üretin. Mineral ve cam dolgulu naylonlar, gerektiğinde mekanik
                  özellikleri iyileştirir.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  Yakıta dayanıklı florosilikon gibi silikon kauçuk malzemeler
                  contalar, keçeler ve borular için kullanılabilir. Lens ve
                  aydınlatma uygulamaları için optik şeffaflıkta silikon kauçuk
                  da mevcuttur.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  Hafifletme için kullanılan bu çok amaçlı metal, mükemmel
                  mukavemet-ağırlık oranı sağlar ve işlenebilir veya 3D baskı
                  ile üretilebilir.
                </p>
              </div>
            </div>
      ...
      <div className="w-full bg-white py-20">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div className="flex-1">
              <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
                Yaygın Otomotiv Uygulamaları
              </h2>
              <div className="w-20 h-1 bg-[#96E92A] rounded-full mb-6"></div>
              <p className="text-gray-600 leading-relaxed">
                Üretim hizmetlerimiz içinde otomotiv endüstrisine yönelik
