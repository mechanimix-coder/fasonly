...
export default function page() {
  ...
  return (
    <div className="w-full pt-10 pb-20 bg-white">
      <ServicesHero
        title="Robotik Otomasyon ve Yapay Zeka"
        desc="Hızlı prototipleme ve talep üzerine üretim ile robotik inovasyonunun gelişimini hızlandırın ve kolaylaştırın"
        bg="/Assets/Images/Industries/robotics/bg.jpg"
        text="black"
        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
              Robotik Şirketleri Fasonly'yi Nasıl Kullanıyor?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Geliştirme hızından ödün vermeden üretim malzemelerinde hızlı
                iterasyon ve prototipleme yoluyla tasarım riskini azaltın.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Çeşitli kalite dokümantasyon seçenekleri ile parça geometrisini
                doğrulayın. Dijital denetim, PPAP ve FAI raporlaması mevcuttur.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Modern sürücülere göre uyarlanmış daha çeşitli ve
                özelleştirilmiş otomotiv özelliklerini mümkün kılmak için düşük
                hacimli üretimi uygulayın.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Otomatik teklif alma, hızlı takım ve düşük hacimli üretim
                parçalarını kullanarak üretim tesislerinizdeki hat duruşu acil
                durumları, parça geri çağırmaları veya diğer tedarik zinciri
                aksaklıkları için talep üzerine destek alın.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full bg-gradient-to-r from-[#0B1221] to-[#1a2a3a] py-16">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          ...
          <p className="text-center text-gray-300 text-lg max-w-3xl mx-auto mb-12">
            Dünya çapındaki yenilikçi robotik şirketleri için 25 yılı aşkın
      ...
      {/* Manufacturing Services for Robotics and AI Products Section */}
      <div className="w-full bg-white py-20">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          {/* Section Header */}
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
              Robotik ve Yapay Zeka Ürünleri için Üretim Hizmetleri
            </h2>
            <div className="w-20 h-1 bg-[#96E92A] mx-auto rounded-full"></div>
          </div>
      ...
      <div className="w-full bg-white py-20">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          ...
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
              Robotik Endüstrisi için Kalite Önlemleri
            </h2>
            <div className="w-20 h-1 bg-[#96E92A] mx-auto rounded-full mb-6"></div>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 mb-20">
            ...
            <div className="flex-1 relative w-full h-80 md:h-auto min-h-[400px] rounded-xl overflow-hidden shadow-md bg-gray-100">
              <Image
                ...
                alt="Robotik Endüstrisi için Kalite Önlemleri"
                fill
                className="object-cover"
              />
            </div>
      ...
      <div className="w-full bg-white py-20">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
              Robotik Uygulamalar için Malzemeler
            </h2>
            <div className="w-20 h-1 bg-[#96E92A] mx-auto rounded-full"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              <div className="relative w-full h-56 overflow-hidden bg-gray-100">
                <Image
                  src="/Assets/Images/Industries/robotics/aluminum.jpg"
                  alt="Alüminyum"
                  fill
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  Hafifletme yetenekleri nedeniyle robotik endüstrisi için
                  popüler bir seçimdir. Belirli alaşımlar ayrıca korozyon
                  direnci, iyi kaynaklanabilirlik ve yüksek ısı direnci
                  sergiler; bunların tümü robotik endüstrisindeki uygulamalar
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              <div className="relative w-full h-56 overflow-hidden bg-gray-100">
                <Image
                  src="/Assets/Images/Industries/robotics/stainless_steel.jpg"
                  alt="Paslanmaz Çelik"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  Robotik endüstrisindekiler tarafından kullanılan yaygın bir
                  malzemedir. Paslanmaz çelik, dayanıklı olması ve
                  tekrarlanabilir süreçler ile zorlu koşullarda hayatta kalması
                  gereken robotik uygulamalardaki bileşenler için sağlam bir
                  seçimdir.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              <div className="relative w-full h-56 overflow-hidden bg-gray-100">
                <Image
                  src="/Assets/Images/Industries/robotics/delrin_material.jpg"
                  alt="Asetal/Delrin"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  Asetal mükemmel boyutsal kararlılığa sahiptir ve düşük
                  sürtünmelidir; bunların her ikisi de kayabilen veya
                  tekrarlanabilir eylemler gerçekleştiren robotik bileşenler
                  için kritik özelliklerdir. Ve endüstride kullanılan diğer
                  yaygın malzemelere kıyasla nispeten ucuzdur.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              <div className="relative w-full h-56 overflow-hidden bg-gray-100">
                <Image
                  src="/Assets/Images/Industries/robotics/silicone_parts.jpg"
                  alt="Elastomerler"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  Elastomerler, daha az ağırlık gerektiren daha hassas görevler
                  için kullanılan yumuşak robotiklerin yükselişi nedeniyle
                  robotik endüstrisinde giderek daha popüler hale gelmektedir.
                  Bu malzemeler ayrıca, esnekliğin gerekli olduğu yarı
                  iletkenler ve gövdeler gibi standart robotlardaki iç
                  bileşenler için de kullanılır.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="w-full bg-white py-20">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div className="flex-1">
              <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
                Yaygın Robotik Uygulamaları
              </h2>
              <div className="w-20 h-1 bg-[#96E92A] rounded-full mb-6"></div>
              <p className="text-gray-600 leading-relaxed">
                Üretim hizmetlerimiz içinde robotik endüstrisine yönelik çeşitli
        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 relative w-full h-80 md:h-96 rounded-xl overflow-hidden shadow-md bg-gray-100">
              <Image
                src="/Assets/Images/Industries/robotics/im_cobot_rosie_03.jpg"
                alt="Robotik Endüstrisi için Hassas Üretim"
                fill
                className="object-cover"
              />
            </div>
            ...
            <div className="flex-1">
              <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
                Robotik Endüstrisi için Hassas Üretim
              </h2>
              <div className="w-20 h-1 bg-[#96E92A] rounded-full mb-6"></div>
              <p className="text-gray-600 leading-relaxed">
                Robotik, çeşitli, nispeten yeni bir endüstridir, ancak en çok
                endüstriyel ve üretim sektörlerinde belirgindir. Buradaki
                uygulamalar arasında robotik kollar, işbirlikçi robotlar (aka{" "}
                <span className="italic">cobot'lar</span>), robotik süreç
                otomasyonu, entegre yapay zeka (AI), öngörücü bakım ve hizmet
                robotları bulunur. Robotik endüstrisi için oluşturulan
                bileşenler için boyutsal doğruluk hayati önem taşır. Parçalar
                karmaşıktır ve bir robot içinde monte edilen diğer bileşenlerle
                senkronize çalışmak için hassas olmalıdır. Tekrarlanabilir
                eylemlerin streslerine dayanmak da esastır. Diğer önemli
                hususlar arasında özelleştirilebilirlik, düşük sürtünmeli yüzey
                işlemleri ve karmaşık geometriler bulunur. Ve bu nedenle dijital
                üretim, robotik endüstrisi için parçaların üretimi ve montajında
