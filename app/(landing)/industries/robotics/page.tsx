...
export default function page() {
  ...
  return (
    <div className="w-full pt-10 pb-20 bg-white">
      <ServicesHero
        title="Robotic Automation and Artificial Intelligence"
        desc="Streamline and accelerate development of robotics innovation with rapid prototyping and on-demand production"
        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1221] mb-4">
              How do Robotics Companies Use Fasonly?
            </h2>
      ...
      <div className="w-full bg-gradient-to-r from-[#0B1221] to-[#1a2a3a] py-16">
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          ...
          <p className="text-center text-gray-300 text-lg max-w-3xl mx-auto mb-12">
            ...
            products for innovative robotics companies around the world.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  ...
                  lightweighting capabilities. Certain alloys also display
                  corrosion resistance, good weldability, and high heat
                  resistance, all important properties to have for applications
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  A common material used by those in the robotics industry.
                  Stainless steel is a solid choice for components on robotic
                  applications that need to be durable and survive repeatable
                  processes and harsh conditions.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  Acetal boasts excellent dimensional stability and has low
                  friction, both critical characteristics for robotic components
                  that may be sliding or performing repeatable actions. And it's
                  relatively inexpensive compared to other common materials used
                  in the industry.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-base leading-relaxed">
                  Elastomers are becoming increasingly popular in the robotics
                  industry due to the rise of soft robotics, which are used for
                  more delicate tasks that require a less heavy hand. These
                  materials are also used for internal components in standard
                  robots, such as semiconductors and casings where flex is
                  needed.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                catered to the robotics industry. Here are a few applications we
                frequently see.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1">
              ...
              <div className="w-20 h-1 bg-[#96E92A] rounded-full mb-6"></div>
              <p className="text-gray-600 leading-relaxed">
                Robotics is a diverse, relatively new industry, but most
                prominent in the industrial and manufacturing sectors.
                Applications here include robotic arms, collaborative robots
                (aka <span className="italic">cobots</span>), robotic process
                automation, integrated artificial intelligence (AI), predictive
                maintenance, and service robots. For components created for the
                robotics industry, dimensional accuracy is vital. Parts are
                complex and must be precise to work in sync with other
                components assembled within a robot. Surviving the stresses of
                repeatable actions is also essential. Other key considerations
                include customizability, low-friction surface finishes and
                complex geometries. And that's why digital manufacturing is
                uniquely valuable in the production and assembly of parts for
